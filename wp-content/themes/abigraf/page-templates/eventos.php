    ...
    <section class="wrapper eventos">
        ...
        <div class="eventos-eventos">
            ...
            foreach ($recent_posts as $events) :
                ...
                $date = $date[0] . '/' . $date[1];
            ?>
                <div class="eventos-eventos-card">
                    <span><img src="<?php get_template_directory_uri(); ?>/assets/images/icons/calendar.svg" alt=""><?php echo $date; ?></span>
        ...
        <section class="wrapper eventos-anteriores">
            ...
            ?>
                <div class="eventos__card">
                    <span class="eventos__date"><?php echo $startDate; ?></span>
